...
{
  J3SocksMethodSelection *selection = [J3SocksMethodSelection socksMethodSelection];
...
- (void) testRequest
{
  J3SocksRequest *request = [J3SocksRequest socksRequestWithHostname: @"example.com" port: 0xABCD];
...
{
  J3SocksAuthentication *auth = [J3SocksAuthentication socksAuthenticationWithUsername: @"bob" password: @"barfoo"];
